...
from prism3d.base_config import InstantiateConfig
from prism3d.spline_functor import (
...
@dataclass
class Prism3DCameraOptimizerConfig(InstantiateConfig):
    """Configuration of PRISM3D camera optimizer."""

    _target: Type = field(default_factory=lambda: Prism3DCameraOptimizer)
...
class Prism3DCameraOptimizer(nn.Module):
    """Optimization for PRISM3D virtual camera trajectories."""

    config: Prism3DCameraOptimizerConfig
