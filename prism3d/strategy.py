...
@dataclass
class Prism3DDefaultStrategy(DefaultStrategy):
    """
    Modified default strategy in PRISM3D that only use the gradients of the
    ...
    def _update_state(
        ...
        if packed:
            # grads is [nnz, 2]
            print("PRISM3D: packed=True may decrease performance")
