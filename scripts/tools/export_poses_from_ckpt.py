...
from prism3d.bad_utils import TrajectoryIO
from prism3d.deblur_nerf_dataparser import DeblurNerfDataParserConfig
from prism3d.spline_functor import linear_interpolation_mid, cubic_bspline_interpolation
...
def export_poses(ckpt_path, data_dir, output_path):
    ...
    if output_path.is_dir():
        output_path = output_path / "PRISM3D.txt"
