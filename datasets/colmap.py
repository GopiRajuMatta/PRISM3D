...
class Dataset:
    ...
    def __getitem__(self, item: int) -> Dict[str, Any]:
        ...
        #print("camera_id",self.parser.image_paths[index], camera_id, self.parser.image_names[index], item, index)
        if len(params) > 0:
        ...
        if self.patch_size is not None:
            ...
            K[0, 2] -= x
            K[1, 2] -= y
        #print("self.parser.image_paths[index]",self.parser.image_paths[index].split("/")[-1], index)
        data = {
